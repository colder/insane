...
the state at the end. Given a state $S$ before the loop, we obtain after $S$
after 0 iterations, and $S \cup \mathcal{F}(S)$ after one iteration. After two
iterations, we obtain $S \cup \mathcal{F}(S) \cup \mathcal{F}(S \cup
\mathcal{F}(S)) = S \cup \mathcal{F}(S) \cup \mathcal{F}^2(S)$.  After $n$
iterations, we get $\bigcup_{i = 0}^n \mathcal{F}^i(S)$.
...
\cup \mathcal{F}(S \cup \mathcal{F}(S)) = S \cup \mathcal{F}(S) \cup
\mathcal{F}^2(S)$. After $n$ recursive call, we obtain: $\bigcup_{i = 0}^n
\mathcal{F}^i(S)$.
