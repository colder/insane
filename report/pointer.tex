...
fact, it is a property of our graphs that every load node is reachable from a non-load node by
following outside edges only. Outside edges are drawn as dashed edges, labelled by
the field read.
...
strong updates as often as the code allows, as discarding old values obviously
