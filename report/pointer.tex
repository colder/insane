...
while outside edges wil be dashed. To illustrate this, we represent in
...
\subsubsection{Nodes}
As stated earlier, nodes generally represents sets of objects. Independently of
their kind, each node carry two pieces of information:
\begin{itemize}
