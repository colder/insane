...
class javaniocharsetCharsetEncoder {
  ...
  def onMalformedInput(x1: java.nio.charset.CodingErrorAction): java.nio.charset.CharsetEncoder = {
  ...
  def onUnmappableCharacter(x1: java.nio.charset.CodingErrorAction): java.nio.charset.CharsetEncoder = {
    new java.nio.charset.CharsetEncoder()
  }
  @AbstractsMethod("java.nio.charset.CharsetEncoder.replaceWith((x$1: Array[Byte])java.nio.charset.CharsetEncoder)")
  def replaceWith(x1: Array[Byte]): java.nio.charset.CharsetEncoder = {
    new java.nio.charset.CharsetEncoder()
  }
}
