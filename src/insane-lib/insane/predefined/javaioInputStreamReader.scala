...
class javaioInputStreamReader {
  ...
  def __init__(x1: java.io.InputStream): javaioInputStreamReader = {
    this
  }
  @AbstractsMethod("java.io.InputStreamReader.<init>((x$1: java.io.InputStream, x$2: java.lang.String)java.io.InputStreamReader)")
  def __init__(x1: java.io.InputStream, x2: java.lang.String): javaioInputStreamReader = {
    this
  }
  ...
  def __init__(x1: java.io.InputStream, x2: java.nio.charset.CharsetDecoder): javaioInputStreamReader = {
    this
  }
