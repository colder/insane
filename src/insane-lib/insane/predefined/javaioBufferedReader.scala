...
class javaioBufferedReader {
  ...
  def PLOPINIT(x1 : java.io.Reader) : java.io.BufferedReader = { new java.io.BufferedReader() }

  @AbstractsMethod("java.io.BufferedReader.<init>((x$1:java.io.Reader, x$2:Int)java.io.BufferedReader)")
  def PLOPINIT(x1 : java.io.Reader, x2 : Int) : java.io.BufferedReader = { new java.io.BufferedReader() }
