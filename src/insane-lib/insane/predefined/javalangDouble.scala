...
class javalangDouble {
  ...
  def compare(x1 : Double, x2 : Double) : Int = { 0 }
  ...
  def isInfinite(x1 : Double) : Boolean = { true }
  ...
  def longBitsToDouble(x1 : Long) : Double = { 0.0d }

  @AbstractsMethod("java.lang.Double.parseDouble((x$1:java.lang.String)Double)")
  def parseDouble(x1 : java.lang.String) : Double = { 0.0d }
  ...
  def valueOf(x1 : Double) : java.lang.Double = { new java.lang.Double() }
