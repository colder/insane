...
class javamathBigDecimal {
  ...
  def abs(x1 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.add((x$1:java.math.BigDecimal, x$2:java.math.MathContext)java.math.BigDecimal)")
  def add(x1 : java.math.BigDecimal, x2 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.byteValueExact(()Byte)")
  def byteValueExact() : Byte = { 0 }

  @AbstractsMethod("java.math.BigDecimal.compareTo((x$1:java.math.BigDecimal)Int)")
  def compareTo(x1 : java.math.BigDecimal) : Int = { 0 }
  ...
  def divideAndRemainder(x1 : java.math.BigDecimal, x2 : java.math.MathContext) : Array[java.math.BigDecimal] = { new Array[java.math.BigDecimal]() }
  ...
  def divideToIntegralValue(x1 : java.math.BigDecimal, x2 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.divide((x$1:java.math.BigDecimal, x$2:java.math.MathContext)java.math.BigDecimal)")
  def divide(x1 : java.math.BigDecimal, x2 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }
  ...
  def PLOPINIT(x1 : java.lang.String, x2 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }
  ...
  def max(x1 : java.math.BigDecimal) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.min((x$1:java.math.BigDecimal)java.math.BigDecimal)")
  def min(x1 : java.math.BigDecimal) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.multiply((x$1:java.math.BigDecimal, x$2:java.math.MathContext)java.math.BigDecimal)")
  def multiply(x1 : java.math.BigDecimal, x2 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.negate((x$1:java.math.MathContext)java.math.BigDecimal)")
  def negate(x1 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.pow((x$1:Int, x$2:java.math.MathContext)java.math.BigDecimal)")
  def pow(x1 : Int, x2 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }
  ...
  def remainder(x1 : java.math.BigDecimal, x2 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.round((x$1:java.math.MathContext)java.math.BigDecimal)")
  def round(x1 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.scale(()Int)")
  def scale() : Int = { 0 }

  @AbstractsMethod("java.math.BigDecimal.setScale((x$1:Int)java.math.BigDecimal)")
  def setScale(x1 : Int) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.setScale((x$1:Int, x$2:Int)java.math.BigDecimal)")
  def setScale(x1 : Int, x2 : Int) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.shortValueExact(()Short)")
  def shortValueExact() : Short = { 0 }
  ...
  def subtract(x1 : java.math.BigDecimal, x2 : java.math.MathContext) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.toBigIntegerExact(()java.math.BigInteger)")
  def toBigIntegerExact() : java.math.BigInteger = { new java.math.BigInteger() }

  @AbstractsMethod("java.math.BigDecimal.toBigInteger(()java.math.BigInteger)")
  def toBigInteger() : java.math.BigInteger = { new java.math.BigInteger() }
  ...
  def ulp() : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.valueOf((x$1:Double)java.math.BigDecimal)")
  def valueOf(x1 : Double) : java.math.BigDecimal = { new java.math.BigDecimal() }

  @AbstractsMethod("java.math.BigDecimal.valueOf((x$1:Long)java.math.BigDecimal)")
  def valueOf(x1 : Long) : java.math.BigDecimal = { new java.math.BigDecimal() }
