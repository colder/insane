...
class javaniocharsetCharsetDecoder {
  ...
  def onMalformedInput(x1: java.nio.charset.CodingErrorAction): java.nio.charset.CharsetDecoder = {
  ...
  def onUnmappableCharacter(x1: java.nio.charset.CodingErrorAction): java.nio.charset.CharsetDecoder = {
    new java.nio.charset.CharsetDecoder()
  }
  @AbstractsMethod("java.nio.charset.CharsetDecoder.replaceWith((x$1: java.lang.String)java.nio.charset.CharsetDecoder)")
  def replaceWith(x1: java.lang.String): java.nio.charset.CharsetDecoder = {
    new java.nio.charset.CharsetDecoder()
  }
}
