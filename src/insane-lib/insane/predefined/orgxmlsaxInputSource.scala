...
class orgxmlsaxInputSource {
  ...
  def PLOPINIT(x1 : java.io.InputStream) : org.xml.sax.InputSource = { new org.xml.sax.InputSource() }

  @AbstractsMethod("org.xml.sax.InputSource.<init>((x$1:java.io.Reader)org.xml.sax.InputSource)")
  def PLOPINIT(x1 : java.io.Reader) : org.xml.sax.InputSource = { new org.xml.sax.InputSource() }

  @AbstractsMethod("org.xml.sax.InputSource.<init>((x$1:java.lang.String)org.xml.sax.InputSource)")
  def PLOPINIT(x1 : java.lang.String) : org.xml.sax.InputSource = { new org.xml.sax.InputSource() }
