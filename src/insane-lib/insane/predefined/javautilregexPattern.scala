...
class javautilregexPattern {
  ...
  def compile(x1 : java.lang.String) : java.util.regex.Pattern = { new java.util.regex.Pattern() }

  @AbstractsMethod("java.util.regex.Pattern.matcher((x$1:java.lang.CharSequence)java.util.regex.Matcher)")
  def matcher(x1 : java.lang.CharSequence) : java.util.regex.Matcher = { new java.util.regex.Matcher() }
  ...
  def split(x1 : java.lang.CharSequence) : Array[java.lang.String] = { new Array[java.lang.String]() }
