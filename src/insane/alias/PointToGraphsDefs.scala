...
trait PointToGraphsDefs {
  ...
  abstract class Field {
    val strName: String
    val fullName: String
    lazy val name: Name = newTermName(strName)
  }

  case class NormalField(val fullName: String, val strName: String) extends Field
  ...
  object Field {
    ...
    def apply(full: String, strName: String): Field = {
      NormalField(full, strName)
    }
  }
